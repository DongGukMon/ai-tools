...
- If an agent failed and you want to preserve context, notes, or session history, use `whip task assign <id> --master-irc <resolved-master-irc>` to re-dispatch the failed task
