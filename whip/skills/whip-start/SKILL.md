...
Whip owns backend-specific prompt, model, effort, and session-forking behavior. Do not describe raw backend CLI flags in the task description unless the user explicitly asked for that.
